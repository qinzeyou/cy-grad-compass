...
> 本文记录早期模拟版界面设计。真实 Codex 开发模式已按 [真实 AI 项目开发规格](superpowers/specs/2026-08-30-real-project-development-design.md) 实现。

## 1. 首版边界

早期版本只实现了模拟界面和模拟运行状态；当前版本已接入本机 Codex CLI，具体权限和事件规则以新规格为准。
